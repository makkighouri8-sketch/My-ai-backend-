...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        .pulse-wave { display: flex; gap: 6px; align-items: center; height: 18px; }
        ...
        /* Input Bar Layout Fix for Mobile */
        ...
        /* Modern Waveform Mic Icon Styling */
        .mic-btn svg { width: 20px; height: 20px; fill: currentColor; }
        
        /* Send Button Size Adjustment */
        .send-btn { border-radius: 50%; width: 42px; height: 42px; border: none; background: #2563eb; color: #fff; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; cursor: pointer; flex-shrink: 0; box-shadow: 0 4px 6px rgba(37, 99, 235, 0.3); }

        /* Plus Menu Modal Options */
        ...
        .menu-item:hover { background: #374151; color: #60a5fa; }
    </style>
</head>
<body>
